...
router.get('/getusercart/:user_id',(req,res)=>{
    const sql = `SELECT * FROM order_details WHERE user_id = ${req.params.user_id}`
})
            ...
            conn.query(sql2,(err,results)=>{
                ...
                conn.query(sql3,(err,results1)=>{
                    ...
                    if(!results1[0]){
                        ...
                        const sql5 = `UPDATE order_details SET quantity = ${updateQty} WHERE product_id = ${data.product_id}`
